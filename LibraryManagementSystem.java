...
public class LibraryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        AdminManager adminManager = new AdminManager(bookManager, userManager, issueManager);
    ...
    static class AdminManager {
        ...
        AdminManager(BookManager bm, UserManager um, IssueManager im) {
            this.bookManager = bm;
            this.userManager = um;
