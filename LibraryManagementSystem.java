...
public class LibraryManagementSystem {
    ...
    public static void main(String[] args) {
        BookManagerInterface bookManager = new DefaultBookManager();
        UserManagerInterface userManager = new DefaultUserManager();
        IssueManagerInterface issueManager = new DefaultIssueManager();

        AdminManager adminManager = new DefaultAdminManager(
                bookManager, userManager, issueManager
        );
    ...
    // --------------------- Abstractions ---------------------
    interface BookManagerInterface extends BookAdder, BookViewer, BookSearcher, BookEditor {}
    interface UserManagerInterface extends AccountCreator, LoginService, UserViewer, FineCalculator {}
    interface IssueManagerInterface extends BookIssuer, BookReturner, IssuedBookViewer {}

    // Book interfaces
    interface BookAdder { void addBook(); }
    interface BookViewer { void viewBooks(); void viewCategories(); }
    interface BookSearcher { void searchBook(); }
    interface BookEditor { void updateBook(); void deleteBook(); }

    // User interfaces
    interface AccountCreator { void createUserAccount(); }
    interface LoginService { void userLogin(); }
    interface UserViewer { void viewUsers(); }
    interface FineCalculator { void calculateFine(); }

    // Issue interfaces
    interface BookIssuer { void issueBook(); }
    interface BookReturner { void returnBook(); }
    interface IssuedBookViewer { void viewIssuedBooks(); void viewOverdueBooks(); }

    interface AdminManager { void adminMenu(); boolean adminLogin(); }

    // ------------------- Implementations -------------------
    static class DefaultBookManager implements BookManagerInterface {
        public void addBook() {
    ...
    static class DefaultUserManager implements UserManagerInterface {
    ...
    static class DefaultIssueManager implements IssueManagerInterface {
    ...
    static class DefaultAdminManager implements AdminManager {
        ...
        DefaultAdminManager(BookManagerInterface bm, UserManagerInterface um, IssueManagerInterface im) {
            this.bookManager = bm;
            this.userManager = um;
